        ...
        i = {
            init: function() {
                return this.each(function() {
                    var b, d, e;
                    d = a(this).css("position", "relative");
                    e = new Object;
                    e.options = a.extend(h, c);
                    b = e.options;
                    typeof b.start == "object" ? 1 : b.start = [b.start];
                    e.slider = d;
                    e.low = a('<div class="noUi-handle noUi-lowerHandle"><div></div></div>');
                    e.up = a('<div class="noUi-handle noUi-upperHandle"><div></div></div>');
                    e.connect = a('<div class="noUi-midBar"></div>');
                    ...
                    if (b.click) {
                        e.slider.click(k.click).find("*:not(.noUi-midBar)").click(k.flse)
                    }
                    j.connect(e);
                    e.options = b;
                    e.slider.data("api", e)
